...
prem_22_23 <- read_html("https://fbref.com/en/comps/9/2022-2023/2022-2023-Premier-League-Stats", as.data.frame=TRUE, stringAsFactors=TRUE) %>% html_nodes("table") %>% .[[2]] %>% html_table(fill=TRUE)

write_csv(prem_22_23, "prem_22_23.csv")

# edit the csv to identify statistics as either home or away
